...
PROC GLOBAL
  ...
  crosstab float(1) f9 Fteams+fintnum+ftotal fhresult+ftotal2
    exclude( percents, totals, specval )
  ...
  crosstab float(1) f10a Fteams+fintnum+ftotal fhresult+ftotal1
    exclude( percents, totals, specval )
...
postproc
  ...
  f10b[*,jtot+1] = ( f10b[*,0] + f10b[*,4]) * 100 / f10b[*,jtot];
